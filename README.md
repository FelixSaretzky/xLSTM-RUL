...
# large runs: generate in a process pool (--workers ~ physical cores)
uv run python -m rulbench.synthetic.rul_hybrid --out data/hybrid_train.h5 --n 200000 --seed 0 --workers 8
```
