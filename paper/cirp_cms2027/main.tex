...
An extended long short-term memory (xLSTM) encoder embeds sliding sensor windows in a latent space that represents a machine dynamics, from which we predict its health state, degradation dynamics, and RUL.
