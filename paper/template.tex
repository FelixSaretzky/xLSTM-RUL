...
- nasa pyprog library: https://nasa.github.io/progpy/
- github?
- synthetic data
- https://github.com/thummd/CausalTimePrior
- https://ch.mathworks.com/de/company/technical-articles/three-ways-to-estimate-remaining-useful-life-for-predictive-maintenance.html
- https://data.phmsociety.org/nasa/
- mehrere prior oder nicht

- felix: eval benchmark datensätze ruassuchen. Univariat?
